  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2.5 border-b border-divider px-4 py-3">
        <span className="text-[11px] text-ink-dim">Declare a target</span>
        <input
          value={name}
  ...
  return (
    <GlassCard className="p-0" glowOnHover>
      ...
      <div className="flex items-center gap-2 px-3 py-2.5">
        ...
        <span className="hidden text-[11.5px] text-ink-dim lg:inline">inert · authorizes nothing</span>
        <div className="flex-1" />
        <Button
          variant="ghost"
          size="sm"
          onClick={onOpen}
          title="Open this target — its Engagements, Workbench, Findings and Reporting"
        >
          Open →
        </Button>
        <button
          ...
          title="Delete target"
          className="rounded-md border border-divider px-2 py-1 text-[11px] text-ink-dim hover:border-danger/40 hover:text-danger"
        >
          Delete
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      {sub.armed ? (
        ...
        <>
          <span className="text-[11.5px] text-ink-dim">un-armed</span>
          <select
            value={pick}
